...
from baselines.ZMTS.runner import AmpRunner
from baselines.ChronosBolt.arch import ChronosBolt
...
# huggingface-cli download autogluon/chronos-bolt-base    --repo-type model   --local-dir ./baselines/ChronosBolt/ckpt/chronos-bolt-base/
...
CFG.TEST.DATA.SHUFFLENODES = False

# CFG.TEST.DATA.PIN_MEMORY = True
# CFG.TEST.DATA.SHUFFLENODES = True
# CFG.TEST.DATA.NUN_SHUFFLENODES = 0.5
# CFG.TEST.DATA.SHUFFLENODES = True
